...
THREE.Ray.prototype = {
  intersectScene: function (a) {
    ...
    var c, d, e, g, f, j, h, i, k, n, m, o = a.geometry, q = o.vertices, r = [];
    c = 0;
    for (d = o.faces.length; c < d; c++) {
      ...
      h = e instanceof THREE.Face4 ? h.multiplyVector3(q[e.d].position.clone()) : null;
      ...
      if (a.doubleSided ||
        ...
        if (e instanceof THREE.Face3) {
          if (b(n, g, f, j)) {
            e = {distance: this.origin.distanceTo(n), point: n, face: e, object: a};
            r.push(e)
          }
        } else if (e instanceof THREE.Face4 && (b(n, g, f, h) || b(n, f, j, h))) {
          e = {distance: this.origin.distanceTo(n), point: n, face: e, object: a};
          r.push(e)
        }
      }
...
THREE.Rectangle = function () {
  ...
  this.add3Points = function (h, i, k, n, m, o) {
    if (j) {
      ...
      b = h < k ? h < m ? h < b ? h : b : m < b ? m : b : k < m ? k < b ? k : b : m < b ? m : b;
      c = i < n ? i < o ? i < c ? i : c : o < c ? o : c : n < o ? n < c ? n : c : o < c ? o : c;
      d = h > k ? h > m ? h > d ? h : d : m > d ? m : d : k > m ? k > d ? k : d : m > d ? m : d;
      e = i > n ? i > o ? i > e ? i : e : o > e ? o : e : n > o ? n > e ? n : e : o > e ? o : e
    }
    a()
  };
  ...
  this.instersects = function (h) {
    return Math.min(d, h.getRight()) - Math.max(b, h.getLeft()) >= 0 && Math.min(e, h.getBottom()) - Math.max(c, h.getTop()) >= 0
  };
  this.empty = function () {
    j = !0;
    e = d = c = b = 0;
...
THREE.Matrix4 = function (a, b, c, d, e, g, f, j, h, i, k, n, m, o, q, r) {
  this.set(a || 1, b || 0, c || 0, d || 0, e || 0, g || 1, f || 0, j || 0, h || 0, i || 0, k || 1, n || 0, m || 0, o || 0, q || 0, r || 1);
  this.flat = Array(16);
...
THREE.Matrix4.prototype = {
  set: function (a, b, c, d, e, g, f, j, h, i, k, n, m, o, q, r) {
    ...
    var d = THREE.Matrix4.__v1,
      e = THREE.Matrix4.__v2, g = THREE.Matrix4.__v3;
    g.sub(a, b).normalize();
    if (g.length() === 0)g.z = 1;
    ...
    var c = a.n11, d = a.n12, e = a.n13, g = a.n14, f = a.n21, j = a.n22, h = a.n23, i = a.n24, k = a.n31, n = a.n32, m = a.n33, o = a.n34, q = a.n41, r = a.n42, v = a.n43, w = a.n44, I = b.n11, D = b.n12, N = b.n13, x = b.n14, l = b.n21, J = b.n22,
      K = b.n23, P = b.n24, L = b.n31, B = b.n32, z = b.n33, M = b.n34;
    ...
    var a =
      this.n11, b = this.n12, c = this.n13, d = this.n14, e = this.n21, g = this.n22, f = this.n23, j = this.n24, h = this.n31, i = this.n32, k = this.n33, n = this.n34, m = this.n41, o = this.n42, q = this.n43, r = this.n44;
    return d * f * i * m - c * j * i * m - d * g * k * m + b * j * k * m + c * g * n * m - b * f * n * m - d * f * h * o + c * j * h * o + d * e * k * o - a * j * k * o - c * e * n * o + a * f * n * o + d * g * h * q - b * j * h * q - d * e * i * q + a * j * i * q + b * e * n * q - a * g * n * q - c * g * h * r + b * f * h * r + c * e * i * r - a * f * i * r - b * e * k * r + a * g * k * r
  }, transpose: function () {
    var a;
    a = this.n21;
    this.n21 = this.n12;
    ...
    var c = Math.cos(b), d = Math.sin(b), e = 1 - c, g = a.x, f = a.y, j = a.z, h = e * g, i = e * f;
    this.set(h *
      g + c, h * f - d * j, h * j + d * f, 0, h * f + d * j, i * f + c, i * j - d * g, 0, h * j - d * f, i * j + d * g, e * j * j + c, 0, 0, 0, 0, 1);
    return this
  ...
  setRotationFromQuaternion: function (a) {
    var b = a.x, c = a.y, d = a.z, e = a.w, g = b + b, f = c + c, j = d + d;
    a = b * g;
    var h = b * f;
    b *= j;
    var i = c * f;
...
THREE.Matrix4.makeInvert = function (a, b) {
  var c = a.n11, d = a.n12, e = a.n13, g = a.n14, f = a.n21, j = a.n22, h = a.n23, i = a.n24, k = a.n31, n = a.n32, m = a.n33, o = a.n34, q = a.n41, r = a.n42, v = a.n43, w = a.n44;
...
THREE.Matrix4.makeInvert3x3 = function (a) {
  var b = a.m33, c = b.m, d = a.n33 * a.n22 - a.n32 * a.n23, e = -a.n33 * a.n21 + a.n31 * a.n23, g = a.n32 * a.n21 - a.n31 * a.n22, f = -a.n33 * a.n12 + a.n32 * a.n13, j = a.n33 * a.n11 - a.n31 * a.n13, h = -a.n32 * a.n11 + a.n31 * a.n12, i = a.n23 * a.n12 - a.n22 * a.n13, k = -a.n23 * a.n11 + a.n21 * a.n13, n = a.n22 * a.n11 - a.n21 * a.n12;
...
THREE.Object3D.prototype = {
  translate: function (a, b) {
    ...
    a = 0;
    for (var d = this.children.length; a < d; a++)this.children[a].update(this.matrixWorld, b, c)
  }
};
...
THREE.Quaternion.prototype = {
  set: function (a, b, c, d) {
    ...
    var b = 0.5 * Math.PI / 360, c = a.x * b, d = a.y * b, e = a.z * b;
    a = Math.cos(d);
    d = Math.sin(d);
    b = Math.cos(-e);
    e = Math.sin(-e);
    ...
    if (a == 0)this.w = this.z = this.y = this.x = 0; else {
      a = 1 / a;
      this.x *= a;
      this.y *= a;
      this.z *= a;
  ...
  multiplySelf: function (a) {
    var b = this.x, c = this.y, d = this.z, e = this.w, g = a.x, f = a.y, j = a.z;
    a = a.w;
    ...
    b || (b = a);
    var c = a.x, d = a.y, e = a.z, g = this.x, f = this.y, j = this.z, h = this.w, i = h * c + f * e - j * d, k =
      h * d + j * c - g * e, n = h * e + g * d - f * c;
    c = -g * c - f * d - j * e;
    b.x = i * h + c * -g + k * -j - n * -f;
    b.y = k * h + c * -f + n * -g - i * -j;
    b.z = n * h + c * -j + i * -f - k * -g;
...
THREE.Quaternion.slerp = function (a, b, c, d) {
  ...
  var g = Math.acos(e), f = Math.sqrt(1 - e * e);
  if (Math.abs(f) < 0.001) {
    c.w = 0.5 * (a.w + b.w);
    c.x = 0.5 * (a.x + b.x);
    c.y = 0.5 * (a.y + b.y);
...
THREE.Geometry.prototype = {
  computeCentroids: function () {
    ...
    var b, c, d, e, g, f, j = new THREE.Vector3, h = new THREE.Vector3;
    d = 0;
    for (e = this.faces.length; d < e; d++) {
      ...
      if (a && g.vertexNormals.length) {
        j.set(0, 0, 0);
        b = 0;
        for (c = g.vertexNormals.length; b < c; b++)j.addSelf(g.vertexNormals[b]);
        j.divideScalar(3)
      } else {
        b = this.vertices[g.a];
        c = this.vertices[g.b];
    ...
    var b, c, d, e, g, f, j, h, i, k, n, m, o, q, r, v, w, I, D, N, x, l, J, K, P = [], L = [], B = new THREE.Vector3, z = new THREE.Vector3, M = new THREE.Vector3, G = new THREE.Vector3, Q = new THREE.Vector3;
    b = 0;
    ...
    for (c = this.faces.length; b < c; b++) {
      ...
      if (g instanceof THREE.Face3)a(this, g.a, g.b, g.c, 0, 1, 2); else if (g instanceof THREE.Face4) {
...
THREE.Camera.prototype.update = function (a, b, c) {
  ...
  for (a = 0; a < this.children.length; a++)this.children[a].update(this.matrixWorld, b, c)
};
...
THREE.LineBasicMaterial = function (a) {
  ...
  a = a || {};
  this.color = a.color !== undefined ? new THREE.Color(a.color) : new THREE.Color(16777215);
...
THREE.MeshBasicMaterial = function (a) {
  ...
  this.refractionRatio = a.refractionRatio !== undefined ? a.refractionRatio : 0.98;
  this.shading =
    a.shading !== undefined ? a.shading : THREE.SmoothShading;
  this.wireframe = a.wireframe !== undefined ? a.wireframe : !1;
  this.wireframeLinewidth = a.wireframeLinewidth !== undefined ? a.wireframeLinewidth : 1;
  this.wireframeLinecap = a.wireframeLinecap !== undefined ? a.wireframeLinecap : "round";
  this.wireframeLinejoin = a.wireframeLinejoin !== undefined ? a.wireframeLinejoin : "round";
  this.vertexColors = a.vertexColors !== undefined ? a.vertexColors : !1;
  this.skinning = a.skinning !== undefined ? a.skinning : !1;
  this.morphTargets = a.morphTargets !== undefined ?
    a.morphTargets : !1
};
...
THREE.MeshPhongMaterial = function (a) {
  ...
  a = a || {};
  this.color = a.color !== undefined ? new THREE.Color(a.color) : new THREE.Color(16777215);
  this.ambient = a.ambient !== undefined ? new THREE.Color(a.ambient) : new THREE.Color(328965);
  this.specular = a.specular !== undefined ? new THREE.Color(a.specular) : new THREE.Color(1118481);
  this.shininess = a.shininess !== undefined ? a.shininess : 30;
  this.map = a.map !== undefined ? a.map : null;
  this.lightMap = a.lightMap !== undefined ? a.lightMap : null;
  this.envMap = a.envMap !== undefined ?
    a.envMap : null;
  this.combine = a.combine !== undefined ? a.combine : THREE.MultiplyOperation;
  this.reflectivity = a.reflectivity !== undefined ? a.reflectivity : 1;
  this.refractionRatio = a.refractionRatio !== undefined ? a.refractionRatio : 0.98;
...
THREE.ParticleBasicMaterial = function (a) {
  ...
  this.sizeAttenuation = a.sizeAttenuation !== undefined ? a.sizeAttenuation : !0;
  this.vertexColors = a.vertexColors !== undefined ? a.vertexColors : !1
};
...
THREE.Mesh.prototype.getMorphTargetIndexByName = function (a) {
  if (this.morphTargetDictionary[a] !== undefined)return this.morphTargetDictionary[a];
...
THREE.Bone.prototype.update = function (a, b, c) {
  ...
  } else for (d = 0; d < e; d++)this.children[d].update(this.skinMatrix,
    b, c)
};
...
THREE.Scene.prototype.addChildRecurse = function (a) {
  if (a instanceof THREE.Light)this.lights.indexOf(a) === -1 && this.lights.push(a); else if (a instanceof THREE.Sound)this.sounds.indexOf(a) === -1 && this.sounds.push(a); else if (!(a instanceof THREE.Camera || a instanceof THREE.Bone) && this.objects.indexOf(a) === -1) {
    this.objects.push(a);
...
THREE.Projector = function () {
  ...
  function c(B, z) {
    var M = 0, G = 1, Q = B.z + B.w, O = z.z + z.w, F = -B.z + B.w, t = -z.z + z.w;
    if (Q >= 0 && O >= 0 && F >= 0 && t >= 0)return !0; else if (Q < 0 && O < 0 || F < 0 && t < 0)return !1; else {
      if (Q < 0)M = Math.max(M, Q / (Q - O)); else O < 0 && (G = Math.min(G, Q / (Q - O)));
      if (F < 0)M = Math.max(M, F / (F - t)); else t < 0 && (G = Math.min(G, F / (F - t)));
      if (G < M)return !1; else {
        B.lerpSelf(z, M);
        z.lerpSelf(B, 1 - G);
        return !0
      }
  ...
  var d, e, g = [], f, j, h = [], i, k, n = [], m, o =
    [], q, r, v = [], w, I, D = [], N = new THREE.Vector4, x = new THREE.Vector4, l = new THREE.Matrix4, J = new THREE.Matrix4, K = [new THREE.Vector4, new THREE.Vector4, new THREE.Vector4, new THREE.Vector4, new THREE.Vector4, new THREE.Vector4], P = new THREE.Vector4, L = new THREE.Vector4;
  ...
  this.projectObjects = function (B, z, M) {
    ...
    for (G = Q.length; B < G; B++) {
      O = Q[B];
      var F;
      if (!(F = !O.visible))if (F = O instanceof THREE.Mesh) {
        a:{
          F = void 0;
          for (var t = O.matrixWorld, C = -O.geometry.boundingSphere.radius * Math.max(O.scale.x, Math.max(O.scale.y, O.scale.z)), A = 0; A < 6; A++) {
  ...
  this.projectScene = function (B, z, M) {
    var G = [], Q = z.near, O = z.far, F, t, C, A, y, s, p, E, R, u, H, S, W, X, T, V, U;
    I = r = m = k = 0;
    ...
    K[4].set(l.n41 - l.n31, l.n42 -
      l.n32, l.n43 - l.n33, l.n44 - l.n34);
        ...
        if (u instanceof THREE.Mesh) {
          ...
          for (t = V.length; A < t; A++) {
            ...
            if (C instanceof THREE.Face3) {
              ...
              s = h[C.b];
              p = h[C.c];
              if (y.visible && s.visible && p.visible && (u.doubleSided || u.flipSided != (p.positionScreen.x - y.positionScreen.x) * (s.positionScreen.y - y.positionScreen.y) - (p.positionScreen.y - y.positionScreen.y) * (s.positionScreen.x -
                y.positionScreen.x) < 0)) {
              ...
              p = h[C.c];
              E = h[C.d];
              if (y.visible && s.visible && p.visible && E.visible && (u.doubleSided || u.flipSided != ((E.positionScreen.x - y.positionScreen.x) * (s.positionScreen.y - y.positionScreen.y) - (E.positionScreen.y - y.positionScreen.y) * (s.positionScreen.x - y.positionScreen.x) < 0 || (s.positionScreen.x - p.positionScreen.x) * (E.positionScreen.y - p.positionScreen.y) -
                (s.positionScreen.y - p.positionScreen.y) * (E.positionScreen.x - p.positionScreen.x) < 0))) {
            ...
            y =
              0;
            for (s = T.length; y < s; y++)if (U = T[y][A]) {
              p = 0;
          ...
          if (x.z > 0 && x.z < 1) {
            ...
            w.scale.x = u.scale.x * Math.abs(w.x - (x.x + z.projectionMatrix.n11) /
                (x.w + z.projectionMatrix.n14));
            w.scale.y = u.scale.y * Math.abs(w.y - (x.y + z.projectionMatrix.n22) / (x.w + z.projectionMatrix.n24));
...
THREE.SVGRenderer = function () {
  ...
  function b(t, C, A, y, s, p) {
    ...
    f.data.faces++;
    G = d(Q++);
    G.setAttribute("d", "M " + t.positionScreen.x + " " + t.positionScreen.y + " L " + C.positionScreen.x + " " + C.positionScreen.y + " L " + A.positionScreen.x + "," + A.positionScreen.y + "z");
    if (s instanceof THREE.MeshBasicMaterial)x.hex = s.color.hex; else if (s instanceof THREE.MeshLambertMaterial)if (N) {
      l.r = J.r;
      l.g = J.g;
      l.b = J.b;
      a(p, y, l);
      ...
      x.updateHex()
    } else x.hex = s.color.hex; else if (s instanceof THREE.MeshDepthMaterial) {
      L =
        1 - s.__2near / (s.__farPlusNear - y.z * s.__farMinusNear);
      x.setRGB(L, L, L)
    } else s instanceof THREE.MeshNormalMaterial && x.setRGB(e(y.normalWorld.x), e(y.normalWorld.y), e(y.normalWorld.z));
    s.wireframe ? G.setAttribute("style", "fill: none; stroke: #" + g(x.hex.toString(16)) + "; stroke-width: " + s.wireframeLinewidth + "; stroke-opacity: " + s.opacity + "; stroke-linecap: " + s.wireframeLinecap + "; stroke-linejoin: " + s.wireframeLinejoin) : G.setAttribute("style", "fill: #" + g(x.hex.toString(16)) + "; fill-opacity: " + s.opacity);
    i.appendChild(G)
  }
  ...
  function c(t, C, A, y, s, p, E) {
    ...
    f.data.faces++;
    G = d(Q++);
    G.setAttribute("d", "M " + t.positionScreen.x + " " + t.positionScreen.y + " L " + C.positionScreen.x + " " + C.positionScreen.y + " L " + A.positionScreen.x + "," + A.positionScreen.y + " L " + y.positionScreen.x + "," + y.positionScreen.y + "z");
    if (p instanceof THREE.MeshBasicMaterial)x.hex = p.color.hex; else if (p instanceof THREE.MeshLambertMaterial)if (N) {
      l.r = J.r;
      l.g = J.g;
      l.b = J.b;
      a(E, s, l);
      x.r = Math.max(0, Math.min(p.color.r * l.r, 1));
      x.g = Math.max(0, Math.min(p.color.g *
        l.g, 1));
      x.b = Math.max(0, Math.min(p.color.b * l.b, 1));
      x.updateHex()
    } else x.hex = p.color.hex; else if (p instanceof THREE.MeshDepthMaterial) {
      L = 1 - p.__2near / (p.__farPlusNear - s.z * p.__farMinusNear);
      x.setRGB(L, L, L)
    } else p instanceof THREE.MeshNormalMaterial && x.setRGB(e(s.normalWorld.x), e(s.normalWorld.y), e(s.normalWorld.z));
    p.wireframe ? G.setAttribute("style", "fill: none; stroke: #" + g(x.hex.toString(16)) + "; stroke-width: " + p.wireframeLinewidth + "; stroke-opacity: " + p.opacity + "; stroke-linecap: " + p.wireframeLinecap +
      "; stroke-linejoin: " + p.wireframeLinejoin) : G.setAttribute("style", "fill: #" + g(x.hex.toString(16)) + "; fill-opacity: " + p.opacity);
    i.appendChild(G)
  }
  ...
  var f = this, j = null, h = new THREE.Projector, i = document.createElementNS("http://www.w3.org/2000/svg", "svg"),
    k, n, m, o, q, r, v, w, I = new THREE.Rectangle, D = new THREE.Rectangle, N = !1, x = new THREE.Color(16777215), l = new THREE.Color(16777215), J = new THREE.Color(0), K = new THREE.Color(0), P = new THREE.Color(0), L, B = new THREE.Vector3, z = [], M = [], G, Q, O, F = 1;
  this.domElement = i;
  this.autoClear = !0;
  this.sortObjects = !0;
  this.sortElements = !0;
  ...
  this.render = function (t, C) {
    ...
    for (y = j.length; A < y; A++) {
      ...
      if (u instanceof THREE.RenderableParticle) {
        ...
        if (I.instersects(D)) {
          s = 0;
          for (p = u.materials.length; s < p;)if ((H = u.materials[s++]) && H.opacity != 0) {
            E = q;
            R = r;
            var S = O++;
            if (M[S] == null) {
              M[S] = document.createElementNS("http://www.w3.org/2000/svg", "line");
            ...
            if (H instanceof THREE.LineBasicMaterial) {
              G.setAttribute("style", "fill: none; stroke: ##" +
                g(H.color.hex.toString(16)) + "; stroke-width: " + H.linewidth + "; stroke-opacity: " + H.opacity + "; stroke-linecap: " + H.linecap + "; stroke-linejoin: " + H.linejoin);
              i.appendChild(G)
            }
          }
        }
        ...
        if (I.instersects(D)) {
          ...
          for (p = u.meshMaterials.length; s < p;) {
            ...
            if (H instanceof THREE.MeshFaceMaterial) {
              E = 0;
              for (R = u.faceMaterials.length; E < R;)(H = u.faceMaterials[E++]) && H.opacity != 0 && b(q, r, v, u, H, t)
        ...
        if (I.instersects(D)) {
          ...
          for (p = u.meshMaterials.length; s < p;) {
            ...
            if (H instanceof THREE.MeshFaceMaterial) {
              E = 0;
              for (R = u.faceMaterials.length; E < R;)(H = u.faceMaterials[E++]) && H.opacity != 0 && c(q, r, v, w, u, H, t)

...
THREE.Ray.prototype = {
  intersectScene: function (a) {
    ...
    var c, d, e, g, f, i, h, j, p, n, o, k = a.geometry, t = k.vertices, w = [];
    c = 0;
    for (d = k.faces.length; c < d; c++) {
      ...
      h = e instanceof THREE.Face4 ? h.multiplyVector3(t[e.d].position.clone()) : null;
      ...
      if (a.doubleSided ||
        ...
        } else if (e instanceof THREE.Face4 && (b(n, g, f, h) || b(n, f, i, h))) {
          e = {distance: this.origin.distanceTo(n), point: n, face: e, object: a};
          w.push(e)
        }
      }
...
THREE.Rectangle = function () {
  ...
  this.add3Points = function (h, j, p, n, o, k) {
    if (i) {
      ...
      b = h < p ? h < o ? h < b ? h : b : o < b ? o : b : p < o ? p < b ? p : b : o < b ? o : b;
      c = j < n ? j < k ? j < c ? j : c : k < c ? k : c : n < k ? n < c ? n : c : k < c ? k : c;
      d = h > p ? h > o ? h > d ? h : d : o > d ? o : d : p > o ? p > d ? p : d : o > d ? o : d;
      e = j > n ? j > k ? j > e ? j : e : k > e ? k : e : n > k ? n > e ? n : e : k > e ? k : e
    }
    a()
  };
...
THREE.Matrix4 = function (a, b, c, d, e, g, f, i, h, j, p, n, o, k, t, w) {
  this.set(a || 1, b || 0, c || 0, d || 0, e || 0, g || 1, f || 0, i || 0, h || 0, j || 0, p || 1, n || 0, o || 0, k || 0, t || 0, w || 1);
  this.flat = Array(16);
...
THREE.Matrix4.prototype = {
  set: function (a, b, c, d, e, g, f, i, h, j, p, n, o, k, t, w) {
    ...
    var c = a.n11, d = a.n12, e = a.n13, g = a.n14, f = a.n21, i = a.n22, h = a.n23, j = a.n24, p = a.n31, n = a.n32, o = a.n33, k = a.n34, t = a.n41, w = a.n42, D = a.n43, x = a.n44, W = b.n11, X = b.n12, aa = b.n13, H = b.n14, q = b.n21, B = b.n22,
      z = b.n23, L = b.n24, Y = b.n31, C = b.n32, A = b.n33, I = b.n34;
    ...
    var a =
      this.n11, b = this.n12, c = this.n13, d = this.n14, e = this.n21, g = this.n22, f = this.n23, i = this.n24, h = this.n31, j = this.n32, p = this.n33, n = this.n34, o = this.n41, k = this.n42, t = this.n43, w = this.n44;
    return d * f * j * o - c * i * j * o - d * g * p * o + b * i * p * o + c * g * n * o - b * f * n * o - d * f * h * k + c * i * h * k + d * e * p * k - a * i * p * k - c * e * n * k + a * f * n * k + d * g * h * t - b * i * h * t - d * e * j * t + a * i * j * t + b * e * n * t - a * g * n * t - c * g * h * w + b * f * h * w + c * e * j * w - a * f * j * w - b * e * p * w + a * g * p * w
  }, transpose: function () {
    var a;
    a = this.n21;
    this.n21 = this.n12;
    ...
    var c = Math.cos(b), d = Math.sin(b), e = 1 - c, g = a.x, f = a.y, i = a.z, h = e * g, j = e * f;
    this.set(h *
      g + c, h * f - d * i, h * i + d * f, 0, h * f + d * i, j * f + c, j * i - d * g, 0, h * i - d * f, j * i + d * g, e * i * i + c, 0, 0, 0, 0, 1);
    return this
  ...
  setRotationFromQuaternion: function (a) {
    var b = a.x, c = a.y, d = a.z, e = a.w, g = b + b, f = c + c, i = d + d;
    a = b * g;
    var h = b * f;
    b *= i;
    var j = c * f;
...
THREE.Matrix4.makeInvert = function (a, b) {
  var c = a.n11, d = a.n12, e = a.n13, g = a.n14, f = a.n21, i = a.n22, h = a.n23, j = a.n24, p = a.n31, n = a.n32, o = a.n33, k = a.n34, t = a.n41, w = a.n42, D = a.n43, x = a.n44;
...
THREE.Matrix4.makeInvert3x3 = function (a) {
  var b = a.m33, c = b.m, d = a.n33 * a.n22 - a.n32 * a.n23, e = -a.n33 * a.n21 + a.n31 * a.n23, g = a.n32 * a.n21 - a.n31 * a.n22, f = -a.n33 * a.n12 + a.n32 * a.n13, i = a.n33 * a.n11 - a.n31 * a.n13, h = -a.n32 * a.n11 + a.n31 * a.n12, j = a.n23 * a.n12 - a.n22 * a.n13, p = -a.n23 * a.n11 + a.n21 * a.n13, n = a.n22 * a.n11 - a.n21 * a.n12;
...
THREE.Quaternion.prototype = {
  ...
  multiplySelf: function (a) {
    var b = this.x, c = this.y, d = this.z, e = this.w, g = a.x, f = a.y, i = a.z;
    a = a.w;
    ...
    b || (b = a);
    var c = a.x, d = a.y, e = a.z, g = this.x, f = this.y, i = this.z, h = this.w, j = h * c + f * e - i * d, p =
      h * d + i * c - g * e, n = h * e + g * d - f * c;
    c = -g * c - f * d - i * e;
    b.x = j * h + c * -g + p * -i - n * -f;
    b.y = p * h + c * -f + n * -g - j * -i;
    b.z = n * h + c * -i + j * -f - p * -g;
...
THREE.Geometry.prototype = {
  computeCentroids: function () {
    ...
    var b, c, d, e, g, f, i = new THREE.Vector3, h = new THREE.Vector3;
    d = 0;
    for (e = this.faces.length; d < e; d++) {
      ...
      if (a && g.vertexNormals.length) {
        i.set(0, 0, 0);
        b = 0;
        for (c = g.vertexNormals.length; b < c; b++)i.addSelf(g.vertexNormals[b]);
        i.divideScalar(3)
      } else {
        b = this.vertices[g.a];
        c = this.vertices[g.b];
    ...
    var b, c, d, e, g, f, i, h, j, p, n, o, k, t, w, D, x, W, X, aa, H, q, B, z, L = [], Y = [], C = new THREE.Vector3, A = new THREE.Vector3, I = new THREE.Vector3, O = new THREE.Vector3, R = new THREE.Vector3;
    b = 0;
...
THREE.Projector = function () {
  ...
  function c(C, A) {
    var I = 0, O = 1, R = C.z + C.w, J = A.z + A.w, y = -C.z + C.w, F = -A.z + A.w;
    if (R >= 0 && J >= 0 && y >= 0 && F >= 0)return !0; else if (R < 0 && J < 0 || y < 0 && F < 0)return !1; else {
      if (R < 0)I = Math.max(I, R / (R - J)); else J < 0 && (O = Math.min(O, R / (R - J)));
      if (y < 0)I = Math.max(I, y / (y - F)); else F < 0 && (O = Math.min(O, y / (y - F)));
      if (O < I)return !1; else {
        C.lerpSelf(A, I);
        A.lerpSelf(C, 1 - O);
        return !0
      }
  ...
  var d, e, g = [], f, i, h = [], j, p, n = [], o, k =
    [], t, w, D = [], x, W, X = [], aa = new THREE.Vector4, H = new THREE.Vector4, q = new THREE.Matrix4, B = new THREE.Matrix4, z = [new THREE.Vector4, new THREE.Vector4, new THREE.Vector4, new THREE.Vector4, new THREE.Vector4, new THREE.Vector4], L = new THREE.Vector4, Y = new THREE.Vector4;
  ...
  this.projectObjects = function (C, A, I) {
    ...
    for (O = R.length; C < O; C++) {
      J = R[C];
      var y;
      if (!(y = !J.visible))if (y = J instanceof THREE.Mesh) {
        a:{
          y = void 0;
          for (var F = J.matrixWorld, Q = -J.geometry.boundingSphere.radius * Math.max(J.scale.x, Math.max(J.scale.y, J.scale.z)), S = 0; S < 6; S++) {
  ...
  this.projectScene = function (C, A, I) {
    var O = [], R = A.near, J = A.far, y, F, Q, S, G, ba, Z, da, M, E, T, $, ea, oa, ia, ka, fa;
    W = w = o = p = 0;
    ...
    z[4].set(q.n41 - q.n31,
      q.n42 - q.n32, q.n43 - q.n33, q.n44 - q.n34);
        ...
        if (E instanceof THREE.Mesh) {
          ...
          for (F = ka.length; S < F; S++) {
            ...
            if (Q instanceof THREE.Face3) {
              ...
              ba = h[Q.b];
              Z = h[Q.c];
              if (G.visible && ba.visible && Z.visible && (E.doubleSided || E.flipSided != (Z.positionScreen.x - G.positionScreen.x) * (ba.positionScreen.y - G.positionScreen.y) - (Z.positionScreen.y - G.positionScreen.y) * (ba.positionScreen.x -
                G.positionScreen.x) < 0)) {
              ...
              Z = h[Q.c];
              da = h[Q.d];
              if (G.visible && ba.visible && Z.visible && da.visible && (E.doubleSided || E.flipSided != ((da.positionScreen.x - G.positionScreen.x) * (ba.positionScreen.y - G.positionScreen.y) - (da.positionScreen.y - G.positionScreen.y) * (ba.positionScreen.x - G.positionScreen.x) < 0 || (ba.positionScreen.x - Z.positionScreen.x) * (da.positionScreen.y -
                Z.positionScreen.y) - (ba.positionScreen.y - Z.positionScreen.y) * (da.positionScreen.x - Z.positionScreen.x) < 0))) {
            ...
            G = 0;
            for (ba = ia.length; G < ba; G++)if (fa = ia[G][S]) {
              Z = 0;
          ...
          if (H.z > 0 && H.z < 1) {
            ...
            x.scale.x =
              E.scale.x * Math.abs(x.x - (H.x + A.projectionMatrix.n11) / (H.w + A.projectionMatrix.n14));
            x.scale.y = E.scale.y * Math.abs(x.y - (H.y + A.projectionMatrix.n22) / (H.w + A.projectionMatrix.n24));
...
THREE.CanvasRenderer = function () {
  ...
  var g = this, f = null, i = new THREE.Projector, h = document.createElement("canvas"), j, p, n, o, k = h.getContext("2d"), t = new THREE.Color(0), w = 0, D = 1, x = 0, W = null, X = null, aa = null, H = null, q = null, B, z, L, Y, C = new THREE.RenderableVertex, A = new THREE.RenderableVertex, I, O, R, J, y, F, Q, S, G, ba, Z, da, M = new THREE.Color(0), E = new THREE.Color(0), T = new THREE.Color(0), $ = new THREE.Color(0), ea = new THREE.Color(0), oa, ia, ka, fa, Wa, Xa, Ya, Za, $a, ab, Ca = new THREE.Rectangle, ma = new THREE.Rectangle, ha = new THREE.Rectangle, Ua = !1, la = new THREE.Color,
    ja = new THREE.Color, Ma = new THREE.Color, Na = new THREE.Color, ca = new THREE.Vector3, Ha, Ia, Va, na, Ja, Oa, Ea = 16;
  ...
  this.clear = function () {
    ...
    if (!ma.isEmpty()) {
      ma.inflate(1);
      ma.minSelf(Ca);
      if (t.hex == 0 && w == 0)k.clearRect(ma.getX(), ma.getY(), ma.getWidth(), ma.getHeight()); else {
        b(THREE.NormalBlending);
        a(1);
        k.fillStyle = "rgba(" + Math.floor(t.r * 255) + "," + Math.floor(t.g * 255) + "," + Math.floor(t.b *
            255) + "," + w + ")";
  ...
  this.render = function (U, pa) {
    ...
    function ta(m, v, s, r) {
      ...
      for (K = V.length; m < K; m++) {
        ...
        if (N instanceof THREE.DirectionalLight) {
          ...
          if (!(l <= 0)) {
            l *= N.distance == 0 ? 1 : 1 - Math.min(v.distanceTo(N.position) / N.distance, 1);
            if (l != 0) {
              l *= N.intensity;
              r.r += u.r * l;
              r.g += u.g * l;
    ...
    function Pa(m, v, s, r, K, N, u, l, V) {
      ...
      Ka(I, O, R, J, y, F);
      if (l instanceof THREE.MeshBasicMaterial)if (l.map) {
        if (l.map.mapping instanceof THREE.UVMapping) {
          fa = u.uvs[0];
          ua(I, O, R, J, y, F, l.map.image, fa[r].u, fa[r].v, fa[K].u, fa[K].v, fa[N].u, fa[N].v)
        }
      } else if (l.envMap) {
      ...
      } else l.wireframe ? ya(l.color, l.wireframeLinewidth, l.wireframeLinecap, l.wireframeLinejoin) : za(l.color); else if (l instanceof THREE.MeshLambertMaterial) {
        if (l.map && !l.wireframe) {
          if (l.map.mapping instanceof THREE.UVMapping) {
            fa = u.uvs[0];
            ua(I,
              O, R, J, y, F, l.map.image, fa[r].u, fa[r].v, fa[K].u, fa[K].v, fa[N].u, fa[N].v)
          }
          b(THREE.SubtractiveBlending)
        }
        if (Ua)if (!l.wireframe && l.shading == THREE.SmoothShading && u.vertexNormalsWorld.length == 3) {
          E.r = T.r = $.r = ja.r;
          E.g = T.g = $.g = ja.g;
          E.b = T.b = $.b = ja.b;
          ...
          M.updateHex();
          l.wireframe ? ya(M, l.wireframeLinewidth, l.wireframeLinecap, l.wireframeLinejoin) : za(M)
        } else l.wireframe ? ya(l.color, l.wireframeLinewidth, l.wireframeLinecap, l.wireframeLinejoin) : za(l.color)
    ...
    function bb(m, v, s, r, K, N, u, l, V) {
      ...
      if (l.map ||
        ...
        if (l instanceof THREE.MeshBasicMaterial) {
          Ra(I, O, R, J, y, F, Q, S);
          l.wireframe ? ya(l.color, l.wireframeLinewidth, l.wireframeLinecap, l.wireframeLinejoin) : za(l.color)
        } else if (l instanceof THREE.MeshLambertMaterial)if (Ua)if (!l.wireframe &&
          l.shading == THREE.SmoothShading && u.vertexNormalsWorld.length == 4) {
          E.r = T.r = $.r = ea.r = ja.r;
          E.g = T.g = $.g = ea.g = ja.g;
          E.b = T.b = $.b = ea.b = ja.b;
          ta(V, u.v1.positionWorld, u.vertexNormalsWorld[0], E);
    ...
    function Qa(m, v, s, r) {
      var K = ~~(m.r * 255), N = ~~(m.g * 255);
      m = ~~(m.b * 255);
      var u = ~~(v.r * 255), l = ~~(v.g * 255);
      v = ~~(v.b * 255);
      var V = ~~(s.r * 255), va = ~~(s.g * 255);
      s = ~~(s.b * 255);
      var qa = ~~(r.r * 255), wa = ~~(r.g * 255);
      r = ~~(r.b * 255);
    ...
    function Aa(m, v) {
      var s = v.x - m.x, r = v.y - m.y, K = 1 / Math.sqrt(s * s + r * r);
      s *= K;
      r *= K;
      v.x += s;
      v.y += r;
    ...
    for (cb = f.length; Sa < cb; Sa++) {
      ...
      if (P instanceof THREE.RenderableParticle) {
        ...
        ha.add3Points(B.positionScreen.x, B.positionScreen.y, z.positionScreen.x, z.positionScreen.y, L.positionScreen.x, L.positionScreen.y);
        if (Ca.instersects(ha)) {
          ra = 0;
          for (Ba = P.meshMaterials.length; ra < Ba;) {
            ...
            if (ga instanceof THREE.MeshFaceMaterial) {
              Ga = 0;
              for (Ta = P.faceMaterials.length; Ga < Ta;)(ga = P.faceMaterials[Ga++]) && ga.opacity != 0 && Pa(B, z, L, 0, 1, 2, P, ga, U)
        ...
        ha.addPoint(B.positionScreen.x,
          B.positionScreen.y);
        ha.addPoint(z.positionScreen.x, z.positionScreen.y);
        ...
        if (Ca.instersects(ha)) {
          ...
          for (Ba = P.meshMaterials.length; ra < Ba;) {
            ...
            if (ga instanceof THREE.MeshFaceMaterial) {
              Ga = 0;
              for (Ta = P.faceMaterials.length; Ga < Ta;)(ga = P.faceMaterials[Ga++]) && ga.opacity != 0 && bb(B, z, L, Y, C, A, P, ga, U)

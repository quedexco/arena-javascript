...
THREE.Ray.prototype = {
  intersectScene: function (a) {
    ...
    var c, d, e, h, f, j, g, i, l, k, m, n = a.geometry, p = n.vertices, q = [];
    c = 0;
    for (d = n.faces.length; c < d; c++) {
      ...
      g = e instanceof THREE.Face4 ? g.multiplyVector3(p[e.d].position.clone()) : null;
      ...
      if (a.doubleSided ||
        ...
        if (e instanceof THREE.Face3) {
          if (b(k, h, f, j)) {
            e = {distance: this.origin.distanceTo(k), point: k, face: e, object: a};
            q.push(e)
          }
        } else if (e instanceof THREE.Face4 && (b(k, h, f, g) || b(k, f, j, g))) {
          e = {distance: this.origin.distanceTo(k), point: k, face: e, object: a};
          q.push(e)
        }
      }
...
THREE.Rectangle = function () {
  ...
  this.add3Points = function (g, i, l, k, m, n) {
    if (j) {
      ...
      b = g < l ? g < m ? g < b ? g : b : m < b ? m : b : l < m ? l < b ? l : b : m < b ? m : b;
      c = i < k ? i < n ? i < c ? i : c : n < c ? n : c : k < n ? k < c ? k : c : n < c ? n : c;
      d = g > l ? g > m ? g > d ? g : d : m > d ? m : d : l > m ? l > d ? l : d : m > d ? m : d;
      e = i > k ? i > n ? i > e ? i : e : n > e ? n : e : k > n ? k > e ? k : e : n > e ? n : e
    }
    a()
  };
  ...
  this.instersects = function (g) {
    return Math.min(d, g.getRight()) - Math.max(b, g.getLeft()) >= 0 && Math.min(e, g.getBottom()) - Math.max(c, g.getTop()) >= 0
  };
  this.empty = function () {
    j = !0;
    e = d = c = b = 0;
...
THREE.Matrix4 = function (a, b, c, d, e, h, f, j, g, i, l, k, m, n, p, q) {
  this.set(a || 1, b || 0, c || 0, d || 0, e || 0, h || 1, f || 0, j || 0, g || 0, i || 0, l || 1, k || 0, m || 0, n || 0, p || 0, q || 1);
  this.flat = Array(16);
...
THREE.Matrix4.prototype = {
  set: function (a, b, c, d, e, h, f, j, g, i, l, k, m, n, p, q) {
    ...
    var d = THREE.Matrix4.__v1,
      e = THREE.Matrix4.__v2, h = THREE.Matrix4.__v3;
    h.sub(a, b).normalize();
    if (h.length() === 0)h.z = 1;
    ...
    var c = a.n11, d = a.n12, e = a.n13, h = a.n14, f = a.n21, j = a.n22, g = a.n23, i = a.n24, l = a.n31, k = a.n32, m = a.n33, n = a.n34, p = a.n41, q = a.n42, t = a.n43, r = a.n44, C = b.n11, G = b.n12, K = b.n13, x = b.n14, o = b.n21, Q = b.n22,
      H = b.n23, N = b.n24, O = b.n31, u = b.n32, s = b.n33, I = b.n34;
    ...
    var a =
      this.n11, b = this.n12, c = this.n13, d = this.n14, e = this.n21, h = this.n22, f = this.n23, j = this.n24, g = this.n31, i = this.n32, l = this.n33, k = this.n34, m = this.n41, n = this.n42, p = this.n43, q = this.n44;
    return d * f * i * m - c * j * i * m - d * h * l * m + b * j * l * m + c * h * k * m - b * f * k * m - d * f * g * n + c * j * g * n + d * e * l * n - a * j * l * n - c * e * k * n + a * f * k * n + d * h * g * p - b * j * g * p - d * e * i * p + a * j * i * p + b * e * k * p - a * h * k * p - c * h * g * q + b * f * g * q + c * e * i * q - a * f * i * q - b * e * l * q + a * h * l * q
  }, transpose: function () {
    var a;
    a = this.n21;
    this.n21 = this.n12;
    ...
    var c = Math.cos(b), d = Math.sin(b), e = 1 - c, h = a.x, f = a.y, j = a.z, g = e * h, i = e * f;
    this.set(g *
      h + c, g * f - d * j, g * j + d * f, 0, g * f + d * j, i * f + c, i * j - d * h, 0, g * j - d * f, i * j + d * h, e * j * j + c, 0, 0, 0, 0, 1);
    return this
  ...
  setRotationFromQuaternion: function (a) {
    var b = a.x, c = a.y, d = a.z, e = a.w, h = b + b, f = c + c, j = d + d;
    a = b * h;
    var g = b * f;
    b *= j;
    var i = c * f;
...
THREE.Matrix4.makeInvert = function (a, b) {
  var c = a.n11, d = a.n12, e = a.n13, h = a.n14, f = a.n21, j = a.n22, g = a.n23, i = a.n24, l = a.n31, k = a.n32, m = a.n33, n = a.n34, p = a.n41, q = a.n42, t = a.n43, r = a.n44;
...
THREE.Matrix4.makeInvert3x3 = function (a) {
  var b = a.m33, c = b.m, d = a.n33 * a.n22 - a.n32 * a.n23, e = -a.n33 * a.n21 + a.n31 * a.n23, h = a.n32 * a.n21 - a.n31 * a.n22, f = -a.n33 * a.n12 + a.n32 * a.n13, j = a.n33 * a.n11 - a.n31 * a.n13, g = -a.n32 * a.n11 + a.n31 * a.n12, i = a.n23 * a.n12 - a.n22 * a.n13, l = -a.n23 * a.n11 + a.n21 * a.n13, k = a.n22 * a.n11 - a.n21 * a.n12;
...
THREE.Quaternion.prototype = {
  ...
  multiplySelf: function (a) {
    var b = this.x, c = this.y, d = this.z, e = this.w, h = a.x, f = a.y, j = a.z;
    a = a.w;
    ...
    b || (b = a);
    var c = a.x, d = a.y, e = a.z, h = this.x, f = this.y, j = this.z, g = this.w, i = g * c + f * e - j * d, l =
      g * d + j * c - h * e, k = g * e + h * d - f * c;
    c = -h * c - f * d - j * e;
    b.x = i * g + c * -h + l * -j - k * -f;
    b.y = l * g + c * -f + k * -h - i * -j;
    b.z = k * g + c * -j + i * -f - l * -h;
...
THREE.Quaternion.slerp = function (a, b, c, d) {
  ...
  var h = Math.acos(e), f = Math.sqrt(1 - e * e);
  if (Math.abs(f) < 0.001) {
    c.w = 0.5 * (a.w + b.w);
    c.x = 0.5 * (a.x + b.x);
    c.y = 0.5 * (a.y + b.y);
...
THREE.Projector = function () {
  ...
  function c(u, s) {
    var I = 0, J = 1, M = u.z + u.w, E = s.z + s.w, w = -u.z + u.w, z = -s.z + s.w;
    if (M >= 0 && E >= 0 && w >= 0 && z >= 0)return !0; else if (M < 0 && E < 0 || w < 0 && z < 0)return !1; else {
      if (M < 0)I = Math.max(I, M / (M - E)); else E < 0 && (J = Math.min(J, M / (M - E)));
      if (w < 0)I = Math.max(I, w / (w - z)); else z < 0 && (J = Math.min(J, w / (w - z)));
      if (J < I)return !1; else {
        u.lerpSelf(s, I);
        s.lerpSelf(u, 1 - J);
        return !0
      }
  ...
  var d, e, h = [], f, j, g = [], i, l, k = [], m, n =
    [], p, q, t = [], r, C, G = [], K = new THREE.Vector4, x = new THREE.Vector4, o = new THREE.Matrix4, Q = new THREE.Matrix4, H = [new THREE.Vector4, new THREE.Vector4, new THREE.Vector4, new THREE.Vector4, new THREE.Vector4, new THREE.Vector4], N = new THREE.Vector4, O = new THREE.Vector4;
  ...
  this.projectObjects = function (u, s, I) {
    ...
    for (J = M.length; u < J; u++) {
      E = M[u];
      var w;
      if (!(w = !E.visible))if (w = E instanceof THREE.Mesh) {
        a:{
          w = void 0;
          for (var z = E.matrixWorld, A = -E.geometry.boundingSphere.radius * Math.max(E.scale.x, Math.max(E.scale.y, E.scale.z)), D = 0; D < 6; D++) {
  ...
  this.projectScene = function (u, s, I) {
    var J = [], M = s.near, E = s.far, w, z, A, D, v, F, B, L, P, y, R, U, W, X, S, V, T;
    C = q = m = l = 0;
    ...
    H[4].set(o.n41 - o.n31, o.n42 -
      o.n32, o.n43 - o.n33, o.n44 - o.n34);
        ...
        if (y instanceof THREE.Mesh) {
          ...
          for (z = V.length; D < z; D++) {
            ...
            if (A instanceof THREE.Face3) {
              ...
              F = g[A.b];
              B = g[A.c];
              if (v.visible && F.visible && B.visible && (y.doubleSided || y.flipSided != (B.positionScreen.x - v.positionScreen.x) * (F.positionScreen.y - v.positionScreen.y) - (B.positionScreen.y - v.positionScreen.y) * (F.positionScreen.x -
                v.positionScreen.x) < 0)) {
              ...
              B = g[A.c];
              L = g[A.d];
              if (v.visible && F.visible && B.visible && L.visible && (y.doubleSided || y.flipSided != ((L.positionScreen.x - v.positionScreen.x) * (F.positionScreen.y - v.positionScreen.y) - (L.positionScreen.y - v.positionScreen.y) * (F.positionScreen.x - v.positionScreen.x) < 0 || (F.positionScreen.x - B.positionScreen.x) * (L.positionScreen.y - B.positionScreen.y) -
                (F.positionScreen.y - B.positionScreen.y) * (L.positionScreen.x - B.positionScreen.x) < 0))) {
            ...
            v =
              0;
            for (F = S.length; v < F; v++)if (T = S[v][D]) {
              B = 0;
          ...
          if (x.z > 0 && x.z < 1) {
            ...
            r.scale.x = y.scale.x * Math.abs(r.x - (x.x + s.projectionMatrix.n11) /
                (x.w + s.projectionMatrix.n14));
            r.scale.y = y.scale.y * Math.abs(r.y - (x.y + s.projectionMatrix.n22) / (x.w + s.projectionMatrix.n24));
...
THREE.DOMRenderer = function () {
  ...
  var a = null, b = new THREE.Projector, c, d, e, h;
